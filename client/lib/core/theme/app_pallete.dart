...
class Pallete {
  ...
  static const Color backgroundColor = Color.fromRGBO(255, 240, 189, 1);
  static const Color appBarColor = Color.fromRGBO(229, 0, 70, 1);
  static const Color fieldBackground = Color.fromRGBO(199, 219, 156, 1);
